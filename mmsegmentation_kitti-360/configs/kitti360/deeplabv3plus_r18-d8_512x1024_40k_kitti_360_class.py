# ------------------------------------------------------------
# Fine-tune DeepLab V3+ R-18-D8 with class weights on KITTI-360 (80 k iters)
# ------------------------------------------------------------
...
model = dict(
    ...
    decode_head=dict(                                # DeepLabV3+ head
        ...
        loss_decode=dict(
            ...
            class_weight=[0.818, 0.851, 0.81, 0.886, 0.896, 0.984, 1.437, 1.045, 0.787, 0.881,
                          0.844, 1.111, 1.139, 0.854, 0.967, 1.172, 1.156, 1.147, 1.215])),
...
work_dir = './work_dirs/deeplabv3plus_r18-d8_k360_40k_class_weights'
