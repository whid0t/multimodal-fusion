...
class WildScenesCylinderMM(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target_points = 400000 # There are no point clouds that are larger than this, but it's better than empty
        ...
        img_rgb = cv2.resize(img_rgb, (2016, 1512)) # Tested with 1008x756, 2016x1512 gives the same performance results as 1008x756
...
class WildScenesDatasetMM(BaseDatasetMM):
    ...
    - `resolution_2d` (optional): Target image resolution (width, height),
      defaults to (1008, 756) if not specified (previously (2016, 1512)).
    ...
    def __init__(self, dataset_opt):
        ...
        self.image_size = tuple(dataset_opt.get("resolution_2d", (2016, 1512))) # Tested with 1008,756, 2016x1512 gives the same performance results as 1008x756
